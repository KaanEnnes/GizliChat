 ...
 * the lifetime of the app so re-rendering a message (e.g. on scroll) never
 * re-fetches. Resolves to null on any failure so callers can just hide the
 * banner instead of showing a broken card.
 */
